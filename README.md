...
The server part is an heavily stripped down version of [wyoming-piper](https://github.com/rhasspy/wyoming-piper) and the gladostts folder is a [Git submodule](https://git-scm.com/book/en/v2/Git-Tools-Submodules) of R2D2FISH's repo. The code is originally a fork of nal3fin's code but it has been heavily modified and Renovate will not run due the fork so the fork was removed.
